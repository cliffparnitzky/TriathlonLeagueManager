...
$GLOBALS['TL_DCA']['tl_module']['palettes']['rscTriathlonLeagueManagerTableManual'] = '{title_legend},name,headline,type;{ligatable_legend},triathlonLeagueRatingType;{template_legend:hide},triathlonLeagueTableTemplate;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
 ...
 * @package    Controller
 */
class tl_module_RscTriathlonLeagueManager extends Backend
{
